...
const responseData = await sendRequest({
     ...
     form.value.type = responseData.data.type;
             ...
             <div class="flex flex-row gap-36">
              <div  class="flex flex-row mt-5 mb-10">
                <div class="w-28  flex justify-center">
                  ...
                  <label for="typefree" class="text-left block cursor-pointer px-3 py-1 shadow  rounded-md h-auto border border-gray-400">
                ...
                <div class="w-28 flex justify-center">
                  ...
                  <label   for="typepaid" class="text-left block cursor-pointer px-3 py-1  shadow  rounded-md h-auto  border border-gray-400">
              ...
              <div v-if="form.type === 'paid'" class="flex flex-row gap-36 mt-2"> 
              ...
              <button v-on:click="updateForm(form.id)" type="submit" class="font-sans p-2 mt-10 rounded-3xl text-xl w-28 h- bg-primary hover:bg-purple-900 text-white"
              >
